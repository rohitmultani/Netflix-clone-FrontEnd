    ...
    >
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={6}>
          ...
          <Grid container rowGap={2} alignItems="center" alignContent="center">
            <Grid item xs={12} md={4} lg={6} className={classes.device}>
              1
            </Grid>
            <Grid item xs={12} md={4} lg={6} className={classes.device}>
              2
            ...
            <Grid
              ...
              xs={12}
              textAlign="center"
              sx={{ border: "solid 0.8px #FFFFFF", padding: "0.5rem" }}
            >
              <Typography
                variant="p"
                component="p"
              ...
              <Typography
                ...
                sx={{ fontSize: "1rem", color: "#C8CAD2" }}
              >
                Enjoy Netflix with other internet connection devices
              </Typography>
            </Grid>
          </Grid>
        </Grid>
